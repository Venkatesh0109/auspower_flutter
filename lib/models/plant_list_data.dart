...
class PlantListData {
  ...
  factory PlantListData.fromRawJson(String str) =>
      PlantListData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PlantListData.fromJson(Map<String, dynamic> json) => PlantListData(
