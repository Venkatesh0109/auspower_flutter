class CompanyListModel {
  ...
  CompanyListModel({this.iserror, this.message, this.data});
...
class CompanyListData {
  ...
  String? minShift;
  String? maxShift;
  double? reverseMachineKWh;
  double? reverseMasterKwh;
  double? reverseKwh;
  String? ipAddress;
  String? slaveId;
  int? port;
